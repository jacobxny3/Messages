...
public class NotificationManager {
    ...
    public void showNotification(String senderName, String message) {
        ...
        if (client.screen instanceof MessageScreen) {
            MessageScreen screen = (MessageScreen) client.screen;
        ...
        if (com.messaging.config.ConfigManager.getInstance().playNotificationSound() && client.player != null) {
