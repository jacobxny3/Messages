...
public class ServerMessageHandler {
    ...
    public static void handleSendMessage(ServerPlayerEntity sender, String recipientName, String message, boolean allowLogging) {
        ...
        ServerPlayerEntity recipient = sender.getEntityWorld().getServer().getPlayerManager().getPlayer(recipientName);
        if (recipient != null) {
            if (allowLogging) {
        ...
        broadcastPlayerList(sender.getEntityWorld().getServer().getPlayerManager().getPlayerList());
    }
    ...
    public static void handlePlayerListRequest(ServerPlayerEntity requester) {
        List<ServerPlayerEntity> players = requester.getEntityWorld().getServer().getPlayerManager().getPlayerList();
