...
public class ServerMessageHandler {
    ...
    public static void handleSendMessage(ServerPlayer sender, String recipientName, String message, boolean allowLogging) {
        ...
        ServerPlayer recipient = sender.level().getServer().getPlayerList().getPlayerByName(recipientName);
        if (recipient != null) {
            if (allowLogging) {
        ...
        broadcastPlayerList(sender.level().getServer().getPlayerList().getPlayers());
    }

    public static void handleHistoryRequest(ServerPlayer requester, String otherPlayer) {
    ...
    public static void handlePlayerListRequest(ServerPlayer requester) {
        List<ServerPlayer> players = requester.level().getServer().getPlayerList().getPlayers();
    ...
    public static void broadcastPlayerList(List<ServerPlayer> players) {
        List<String> playerNames = new ArrayList<>();
        for (ServerPlayer player : players) {
            playerNames.add(player.getName().getString());
        }
