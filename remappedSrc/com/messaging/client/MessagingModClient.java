...
public class MessagingModClient implements ClientModInitializer {
    private static KeyMapping openMessagesKey;
    ...
    public void onInitializeClient() {
        ...
        openMessagesKey = KeyBindingHelper.registerKeyBinding(new KeyMapping(
                "key.messaging.open",
        ...
        ClientTickEvents.END_CLIENT_TICK.register(client -> {
            while (openMessagesKey.consumeClick()) {
        ...
        HudRenderCallback.EVENT.register((context, tickDelta) -> {
            Matrix3x2f matrix = new Matrix3x2f(context.pose());
